...
# Summary: ROSMAP excitatory neuron sampling for label transfer reference
#
#-------------------------------------------------------------------------------
...
for(cell in celltypes){
  ...
  selected <- sample(EN@meta.data$cellnumber[EN@meta.data$ct == cell], 5000, replace = FALSE)
