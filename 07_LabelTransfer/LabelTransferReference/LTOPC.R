...
# Summary: ROSMAP oligodendrocyte precursor cell sampling for label transfer reference
#
#-------------------------------------------------------------------------------
...
selected <- sample(OPC@meta.data$cellnumber, 5000, replace = FALSE)
