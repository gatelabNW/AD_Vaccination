...
# Results can be read in later to skip all the above
# plotgenes <- read.csv("/projects/p31535/thomas/AN1792Pub/AmyloidDistanceCorrelations/Cohort1/GrayMatter/AllGroups/Combined/AmyloidSigGenes.csv")
