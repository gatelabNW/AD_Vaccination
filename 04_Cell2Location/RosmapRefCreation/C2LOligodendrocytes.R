...
# Summary: ROSMAP oligodendrocyte sampling for spatial reference
#
#-------------------------------------------------------------------------------
...
selected <- sample(oligodendrocyte@meta.data$cellnumber, 2000, replace = FALSE)
...
saveRDS(newoligodendrocyte, "oligodendrocyte.rds")