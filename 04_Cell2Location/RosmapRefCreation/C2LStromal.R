...
# Summary: ROSMAP stromal cell sampling for spatial reference
#
#-------------------------------------------------------------------------------
...
for(cell in celltypes){
  ...
  selected <- sample(stromal@meta.data$cellnumber[stromal@meta.data$ct == cell], 2000, replace = FALSE)
...
saveRDS(newStromal, "stromal.rds")