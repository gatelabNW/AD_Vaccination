...
# Summary: ROSMAP endothelial cell sampling for spatial reference
#
#-------------------------------------------------------------------------------
...
selected <- sample(endothelial@meta.data$cellnumber, 2000, replace = FALSE)
...
saveRDS(newendothelial, "endothelial.rds")