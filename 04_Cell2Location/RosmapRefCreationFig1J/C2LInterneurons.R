...
# Summary: ROSMAP interneuron sampling for spatial reference
#
#-------------------------------------------------------------------------------
...
selected <- sample(interneuron@meta.data$cellnumber, 2000, replace = FALSE)
...
saveRDS(newinterneuron, "interneuron.rds")