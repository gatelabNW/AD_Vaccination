...
# Summary: ROSMAP Astrocyte sampling for spatial reference
#
#-------------------------------------------------------------------------------
...
selected <- sample(astrocyte@meta.data$cellnumber, 2000, replace = FALSE)
...
saveRDS(newastrocyte, "astrocyte.rds")