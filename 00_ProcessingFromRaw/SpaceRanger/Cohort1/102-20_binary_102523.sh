...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-20/"
...
--id="AN1792_102-20" \
--sample="AN1792_102-20" \
--description="AN1792_102-20_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-20.tif" \
--darkimage="${hi_res_image_dir}102-20_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42L25-073-A1.json" \
--slide="V42L25-073" \
--area="A1" \
--localcores=16 \
--localmem=128