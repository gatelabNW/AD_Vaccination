...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-19/"
...
--id="AN1792_102-19" \
--sample="AN1792_102-19" \
--description="AN1792_102-19_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-19.tif" \
--colorizedimage="${hi_res_image_dir}102-19_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-307-D1.json" \
--slide="V42Y04-307" \
--area="D1" \
--localcores=16 \
--localmem=128