...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/N35127N/"
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}N35127N.tif" \
--darkimage="${hi_res_image_dir}N35127A_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-328-D1.json" \
--slide="V42Y04-328" \
--area="D1" \
--localcores=16 \
--localmem=128