...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-8/"
...
--id="AN1792_102-8" \
--sample="AN1792_102-8" \
--description="AN1792_102-8_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-8.tif" \
--colorizedimage="${hi_res_image_dir}102-8_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-303-A1.json" \
--slide="V42Y04-303" \
--area="A1" \
--localcores=16 \
--localmem=128