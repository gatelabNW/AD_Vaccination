...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-11/"
...
--id="AN1792_102-11" \
--sample="AN1792_102-11" \
--description="AN1792_102-11_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-11.tif" \
--darkimage="${hi_res_image_dir}102-11_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-312-D1.json" \
--slide="V42Y04-312" \
--area="D1" \
--localcores=16 \
--localmem=128