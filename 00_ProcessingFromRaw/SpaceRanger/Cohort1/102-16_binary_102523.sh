...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-16/"
...
--id="AN1792_102-16" \
--sample="AN1792_102-16" \
--description="AN1792_102-16_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-16.tif" \
--darkimage="${hi_res_image_dir}102-16_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-307-A1.json" \
--slide="V42Y04-307" \
--area="A1" \
--localcores=16 \
--localmem=128