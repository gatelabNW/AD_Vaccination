...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/A34995/"
...
--id="A34995" \
--sample="A34995" \
--description="AN1792_A34995_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}A34995.tif" \
--darkimage="${hi_res_image_dir}A34995A_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42L25-076-D1.json" \
--slide="V42L25-076" \
--area="D1" \
--localcores=16 \
--localmem=128