...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-17/"
...
--id="AN1792_102-17" \
--sample="AN1792_102-17" \
--description="AN1792_102-17_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-17.tif" \
--colorizedimage="${hi_res_image_dir}102-17_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42L28-394-D1.json" \
--slide="V42L28-394" \
--area="D1" \
--localcores=16 \
--localmem=128