...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/A34583-2/"
...
--id="A34583-2" \
--sample="A34583-2" \
--description="AN1792_34583A_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}A34583-2.tif" \
--darkimage="${hi_res_image_dir}A34583A_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42L25-113-D1.json" \
--slide="V42L25-113" \
--area="D1" \
--localcores=16 \
--localmem=128