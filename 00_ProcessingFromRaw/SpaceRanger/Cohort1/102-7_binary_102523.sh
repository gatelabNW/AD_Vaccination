...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-7/"
...
--id="AN1792_102-7" \
--sample="AN1792_102-7" \
--description="AN1792_102-7_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-7.tif" \
--darkimage="${hi_res_image_dir}102-7_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-306-A1.json" \
--slide="V42Y04-306" \
--area="A1" \
--localcores=16 \
--localmem=128