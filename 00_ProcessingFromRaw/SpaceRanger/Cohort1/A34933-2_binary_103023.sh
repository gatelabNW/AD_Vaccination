...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/A34933-2/"
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}A34933-2.tif" \
--darkimage="${hi_res_image_dir}34933A_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42L25-052-D1.json" \
--slide="V42L25-052" \
--area="D1" \
--localcores=16 \
--localmem=128