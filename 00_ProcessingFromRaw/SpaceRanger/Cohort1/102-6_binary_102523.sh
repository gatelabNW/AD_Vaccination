...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-6/"
...
--id="AN1792_102-6" \
--sample="AN1792_102-6" \
--description="AN1792_102-6_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-6.tif" \
--darkimage="${hi_res_image_dir}102-6_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42L25-073-D1.json" \
--slide="V42L25-073" \
--area="D1" \
--localcores=16 \
--localmem=128