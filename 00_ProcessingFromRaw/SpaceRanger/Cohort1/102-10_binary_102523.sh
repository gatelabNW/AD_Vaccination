...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-10/"
...
--id="AN1792_102-10" \
--sample="AN1792_102-10" \
--description="AN1792_102-10_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-10.tif" \
--darkimage="${hi_res_image_dir}102-10_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-305-A1.json" \
--slide="V42Y04-305" \
--area="A1" \
--localcores=16 \
--localmem=128