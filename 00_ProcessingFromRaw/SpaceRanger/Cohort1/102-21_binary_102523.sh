...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-21/"
...
--id="AN1792_102-21" \
--sample="AN1792_102-21" \
--description="AN1792_102-21_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-21.tif" \
--darkimage="${hi_res_image_dir}102-21_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42L28-394-A1.json" \
--slide="V42L28-394" \
--area="A1" \
--localcores=16 \
--localmem=128