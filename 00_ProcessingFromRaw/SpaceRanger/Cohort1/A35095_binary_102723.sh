...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/A35095/"
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}A35095.tif" \
--darkimage="${hi_res_image_dir}A35095_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-324-A1.json" \
--slide="V42Y04-324" \
--area="A1" \
--localcores=16 \
--localmem=128