...
fastq_dir="/projects/b1169/alex/submit-spaceranger/AN1792_fastqs/102-4/"
...
--id="AN1792_102-4" \
--sample="AN1792_102-4" \
--description="AN1792_102-4_binary" \
...
--fastqs="${fastq_dir}" \
--cytaimage="${cytassist_image_dir}AN1792 102-4.tif" \
--darkimage="${hi_res_image_dir}102-4_multi_SR_8bit.tif" \
--loupe-alignment="${alignment_dir}V42Y04-312-A1.json" \
--slide="V42Y04-312" \
--area="A1" \
--localcores=16 \
--localmem=128