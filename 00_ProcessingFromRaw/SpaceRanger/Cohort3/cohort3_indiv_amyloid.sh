...
output_dir="/projects/b1042/Gate_Lab/alex/spaceranger-output/AN1792/cohort3/amyloid/"
...
--darkimage="${hi_res_image_dir}$6.tif" \
--loupe-alignment="${alignment_dir}${3}-${4}-amyloid.json" \
--slide="${3}" \
--area="${4}" \
--localcores=16 \
--localmem=128
